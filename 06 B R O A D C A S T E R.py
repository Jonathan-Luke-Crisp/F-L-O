...
if __name__ == "__main__":
    ...
    if collected_sats < total_needed:
        print(f"\nInsufficient funds. Found {collected_sats / 100_000_000:.8f} FLO. You need {total_needed / 100_000_000:.8f} FLO")
        exit()
        
    change_sats = collected_sats - total_needed
    
    final_hex = construct_tx(private_key, sender_address, dest_address, amount_sats, change_sats, flo_data, selected_utxos)
